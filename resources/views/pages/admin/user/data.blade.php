        ...
        <div class="card mb-4">
            <div class="card-body table-responsive">
                <div class="d-sm-flex align-items-center justify-content-between">
                    <a href="{{ route('admin.create') }}" type="button" class="btn btn-primary mb-3"><i
                        ...
                        @if ($admins ->count())
                            @foreach ($admins as $admin)
                                <tr>
                                    ...
                                    <td class="text-center">{{ $admin->no_telp }}</td>
                                    <td class="text-center">
                                        <a href="{{route('admin.edit', $admin->id_admin)}}" class="badge bg-warning"><i
                                                class="fa-solid fa-pen-to-square"></i>
                                        </a>
                                        <form action="{{route('admin.delete', $admin->id_admin)}}" method="POST"
                                            class="d-inline">
                                            @method('delete')
                                            @csrf
